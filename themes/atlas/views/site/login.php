...
<?php if (param('uLoginEnable')) {
    $redirectUri = urlencode(Yii::app()->createAbsoluteUrl('/site/socLogin'));
    ?>
    <script src="//ulogin.ru/js/ulogin.js"></script>
    <div id="uLogin" data-ulogin="display=panel;theme=classic;fields=first_name,last_name;providers=vkontakte,odnoklassniki,mailru,google;hidden=other;redirect_uri=<?= $redirectUri ?>;mobilebuttons=0;"></div>
<?php } ?>
