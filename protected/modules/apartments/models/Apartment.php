...
//        $this->active = 1;
    ...
    public function beforeSave()
    {
        ...
        if ($this->parent_id && $this->objType && !$this->objType->parent_id) {
            ...
            $this->loc_country = $this->parent->loc_country;
            $this->loc_region = $this->parent->loc_region;
            $this->loc_city = $this->parent->loc_city;

            $this->city_id = $this->parent->city_id;

            $activeLangs = Lang::getActiveLangs(true);

            foreach ($activeLangs as $lang) {
                $attr = 'address_' . $lang['name_iso'];
